...
function ffsb_slider_addslide($filename, $position, $file_id, $text) {
    ...
    exit(wp_redirect(admin_url('admin.php?page=flat-file-slider-top')));
}

function ffsb_slider_add_submenu_page() {
    add_submenu_page(
            'flat-file-slider-top', 'Add Slide', 'Add Slide', 'manage_options', 'addnew_slider', 'ffsb_slider_add_options_function'
    );
}
